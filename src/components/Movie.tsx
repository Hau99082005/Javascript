...
const Card = () => {
  return (
    <div className="px-4 py-6 bg-[#0f0f1a]">
      <h2 className='text-white font-semibold text-center justify-center uppercase' style={{fontFamily: "Lato", fontWeight: "bolder"}}>Phim Sắp Chiếu</h2>
     <Swiper
